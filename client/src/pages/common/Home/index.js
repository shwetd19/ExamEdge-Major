                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    try {
                      ...
                      // Use the stream as needed, for example, display the video in a video element
                      // You might want to stop the stream when it's no longer needed
                      stream.getTracks().forEach((track) => track.stop());

                      // Navigate to the write exam page
